$(function () {
  ...
  var jobTable = $("#job_list").dataTable({
                                            ...
                                            "columns": [
                                              ...
                                              { "data": 'alarmEmail', "visible": false },
                                              {
                                                ...
                                                "render": function (data, type, row) {
                                                  if ('NORMAL' == data) {
                                                    return '<small class="label label-success" ><i class="fa fa-clock-o"></i>' + data +
                                                           '</small>';
                                                  } else if ('PAUSED' == data) {
                                                    return '<small class="label label-default" ><i class="fa fa-clock-o"></i>' + data +
                                                           '</small>';
               ...
               success: function (data) {
                 if (data.code == 200) {
                   ...
                   layer.open({
                                ...
                                btn: [I18n.system_ok],
                                content: (
                                  data.msg || typeName + I18n.system_fail),
                                icon: '2'
                              });
                 }
               },
             ...
             success: function (data) {
               if (data.code == 200) {
                 ...
                 layer.open({
                              ...
                              btn: [I18n.system_ok],
                              content: (
                                data.msg || I18n.jobinfo_opt_run + I18n.system_fail),
                              icon: '2'
                            });
               }
             }
  ...
  var addModalValidate = $("#addModal .form").validate({
                                                         ...
                                                         submitHandler: function (form) {
                                                           ...
                                                           var executorFailRetryCount = $(
                                                             "#addModal .form input[name='executorFailRetryCount']").val();
                                                           ...
                                                           $.post(base_url + "/jobinfo/add", $("#addModal .form").serialize(),
  ...
  var updateModalValidate = $("#updateModal .form").validate({
                                                               ...
                                                               submitHandler: function (form) {
                                                                 ...
                                                                 // process
                                                                 var executorTimeout = $("#updateModal .form input[name='executorTimeout']")
                                                                 .val();
                                                                 if (!/^\d+$/.test(executorTimeout)) {
                                                                   executorTimeout = 0;
                                                                 }
                                                                 ...
                                                                 var executorFailRetryCount = $(
                                                                   "#updateModal .form input[name='executorFailRetryCount']").val();
                                                                 if (!/^\d+$/.test(executorFailRetryCount)) {
                                                                   executorFailRetryCount = 0;
                                                                 }
                                                                        ...
                                                                        function (data, status) {
                                                                          if (data.code == "200") {
                                                                            ...
                                                                            layer.open({
                                                                                         ...
                                                                                         btn: [I18n.system_ok],
                                                                                         content: (
                                                                                           data.msg || I18n.system_update_fail),
                                                                                         icon: '2'
                                                                                       });
                                                                          }
                                                                        });
   ...
   * 执行器组选择事件
   */
  $("#jobGroupSelect").bind("change", function () {
    buildJobHandlerSelect()
  });

  function buildJobHandlerSelect() {
    var url = base_url + "/jobinfo/handlers";
    $.ajax({
             type: 'POST',
             url: url,
             data: { "jobGroupId": $("#jobGroupSelect").val() },
             dataType: "json",
             success: function (data) {
               if (data.code == 200) {
